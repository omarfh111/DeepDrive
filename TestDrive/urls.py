...
from .views import TestDriveCreate, TestDriveList,TestDriveDetails,TestDriveUpdate,admin_testdrive_list,admin_testdrive_update,admin_testdrive_detail,admin_testdrive_delete,admin_testdrive_add
urlpatterns = [
